...
@register_model
def pvihg_ti_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
...
@register_model
def pvihg_s_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
            self.k = 25  # hyperedge num (default:25)
            self.conv = 'hypergraph'  # graph conv layer {edge, mr, hypergraph}
...
@register_model
def pvihg_m_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
            self.k = 25  # hyperedge num (default:25)
            self.conv = 'hypergraph'  # graph conv layer {edge, mr, hypergraph}
...
@register_model
def pvihg_b_224_gelu(pretrained=False, **kwargs):
    class OptInit:
        def __init__(self, num_classes=1000, drop_path_rate=0.0, **kwargs):
            self.k = 25  # hyperedge num (default:25)
            self.conv = 'hypergraph'  # graph conv layer {edge, mr, hypergraph}
